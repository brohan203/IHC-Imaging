...
image = '/Users/ro/Documents/Alkayed Lab/Image 4.tif'
...
deg_rads = np.arange(0.0,45.0,90.0,135.0)*pi/180.0
ksize = 8
sigma = 4
lambd = 4
psi = 0
...
ovl = mark_boundaries(I, mask_final, color=(0, 1,1))


io.imsave('/Users/ro/Documents/mask.png', mask_final, cmap="gray")   
io.imsave('/Users/ro/Documents/overlay.png', ovl)   
